...
4. execute command: `git clone https://github.com/Monedita/portfolioBackend.git`.
5. go inside of created folder: `cd portfolioBackend`.
6. execute command: `docker compose up -d`.
7. Wait until the seeding process is complete and the development server has started.
8. In your browser, navigate to: `http://localhost:3000/api-docs`.
9. When finished, in the terminal execute the command: `docker compose down`.
